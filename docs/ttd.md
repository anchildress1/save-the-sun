...
- [ ] Spoken Hex/Scry/Pass — when Sköll's question hangs, classify the held utterance into a reaction instead of the Ask path (today it hits the unparseable refusal and the window hangs).
