...
- [x] Consistency check: after a mid-round reload the board marks + voiced line match what the **debug log** shows for the same round — no silent divergence
