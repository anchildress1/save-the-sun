...
- [x] Header: title "Save the Sun", tagline "A rite for the longest day," _(changed 2026-06-09 — the built header still carries the old line; update the component + its test)_ night-progress indicator, turn pill ("Your move." / "Sköll moves.")
