...
- [ ] "Is the power white?" → `fill = Light` _(white pips = light)_
- [ ] "Is the power black?" → `fill = Dark` _(black pips = dark — the pips, not the Black hue)_
- [ ] "Is it white?" → `fill = Light` _(white is not a rune hue)_
