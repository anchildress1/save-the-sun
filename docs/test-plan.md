...
| Header chrome | Component + e2e | Title, tagline ("A rite for the longest day."), night-progress indicator, and painted moon movement as turns pass; the moon fully sets on a human win; the turn pill ("Your move." / "Sköll moves.") sits at the top of the Oracle panel beside the controls it gates (moved off the header in S7). |
