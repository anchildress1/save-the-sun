...
- **Right column:** the Rite transcript (You / Oracle / Sköll, with interpretation echoes) → the Reactions panel (Scry · Hex) → the "Ask the Oracle — element, power, light, or hue" free-text input → the "Cast the rune" button. No suggestion chips — pre-filled questions would do the player's deduction for them, and the deduction is the game.
