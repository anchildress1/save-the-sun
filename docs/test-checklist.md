...
- [ ] [C] Each card shows glyph, swatch, name + meaning, power pips (count = power, fill = light/dark: hollow ○ light, solid ● dark) **with numeral**, element symbol + name, color name
- [ ] [A] Color name + element name accompany icons; light/dark rides the pip fill — nothing by color alone
